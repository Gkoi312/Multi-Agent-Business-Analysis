"""
Structured logging — shared ``structlog``-based logger for the whole backend.

Logging is an observability primitive (same family as tracing and metrics),
so it lives here rather than as its own top-level harness module.
"""
import os
import logging
